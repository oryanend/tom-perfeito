...
public class StatusService {
    ...
    public Map<String, Object> getStatus() {
        ...
        response.put("updated_at", Instant.now().atZone(ZoneId.of("UTC")).format(DateTimeFormatter.ISO_INSTANT));
    ...
    private Map<String, Object> getWebServerInfo() {
        ...
        webInfo.put("status", healthEndpoint.health().getStatus().getCode().equals("UP") ? "healthy" : "down");
