...
public class V21__InsertNewChords extends BaseJavaMigration {
  private static final String FILE_PATH = "db/chordsUpdated.csv";
  ...
  public void migrate(Context context) throws Exception {
    ...
    InputStream is = V21__InsertNewChords.class.getClassLoader().getResourceAsStream(FILE_PATH);
    ...
    try (BufferedReader reader = new BufferedReader(new InputStreamReader(is))) {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        if (noteIds.length < 3) {
          throw new IllegalStateException("Chord deve ter no mínimo 3 notes: " + name);
        }
  ...
  private void insertChordNotes(Connection conn, Long chordId, String[] noteIds)
      throws SQLException {
